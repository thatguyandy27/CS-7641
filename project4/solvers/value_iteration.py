...
class ValueIterationSolver(BaseSolver):
    ...
    def __init__(self, env, discount_factor=0.9, theta=0.00001, verbose=False):
        ...
        self._V = np.random.rand(self._env.nS)
        ...
        self._step_times = []
        self.times_converged = 0
        self.max_convergence = 10
    ...
    def has_converged(self):
        is_converged =  self._last_delta < self._theta
        # if is_converged:
        #     self.times_converged += 1
        # else:
        #     self.times_converged = 0
        #
        # # print("Times Converged: ", self.times_converged)
        # # print("Max Converged: ", self.max_convergence)
        # return self.times_converged >= self.max_convergence
        return is_converged
