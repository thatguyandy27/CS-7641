...
if __name__ == '__main__':
    ...
    parser.add_argument('--diabetes', action='store_true', help='Run only diabetes')
    ...
    if args.wine and args.diabetes:
    ...
    datasets = [
        {
            'data': loader.DiabetesRenop(verbose=verbose, seed=seed),
            'name': 'diabetes',
